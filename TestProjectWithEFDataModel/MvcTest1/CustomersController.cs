...
namespace MvcTest1.Views
{
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerID,DateOfBirth,DateOfDeath,FirstName,LastName,RecordGuid,RCD,LMD,RowVersion")] Customer customer)
        {
            if (ModelState.IsValid)
            {
