...
namespace MvcTest1.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            ViewBag.PersonID = new SelectList(db.People, "PersonID", "PersonType");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerID,PersonID,IsActive,RecordGuid,RCD,LMD,RowVersion")] Customer customer)
        {
            if (ModelState.IsValid)
            {
